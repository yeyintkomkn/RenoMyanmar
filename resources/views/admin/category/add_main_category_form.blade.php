...
<div id="loginbox">
    ...
    @endif
    <form id="loginform" method="post" class="form-vertical" action="{{url('add_main_category')}}">
        {{csrf_field()}}
        ...
        <div class="control-group">
            <div class="controls">
                <div class="main_input_box">
                    <span class="add-on bg_lg"><i class="icon-user"> </i></span><input type="text" name="category_name" placeholder="CategoryName" />
                </div>
            </div>
        </div>

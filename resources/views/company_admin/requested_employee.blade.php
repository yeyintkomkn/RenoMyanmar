                                ...
                                <table class="table" id="pending_company_datatable">
                                    ...
                                    @foreach($employee as $data)
                                        <tr>
                                            ...
                                            {{--<td>Note</td>--}}
                                            {{--<td>File</td>--}}
                                            <td><button class="btn btn-primary btn-sm" onclick="show_edit_model({{$data->id}})">Detail</button></td>
                                        </tr>
                                        @endforeach
                                    </tbody>
                                </table>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            ...
                            <div id="file_ui">
                                ...
                                <p>
                                    <a href="#" target="_blank" id="attach_file" class="btn btn-danger text-white">CV pdf</a>
                                </p>
                            </div>
                            {{--<div>--}}

...
{{--    <link href="{{url('css/backend_css/font-awesome.css')}}" rel="stylesheet" />--}}
    ...
    <link rel="stylesheet" href="{{url('css/backend_css/font-awesome.css')}}">

    <link rel="stylesheet" href="{{url('css/backend_css/jquery.gritter.css')}}" />
    {{--<link href='http://fonts.googleapis.com/css?family=Open+Sans:400,700,800' rel='stylesheet' type='text/css'>--}}
    <link href='{{url('css/backend_css/googlefont.css')}}' rel='stylesheet' type='text/css'>
    @yield('css')
</head>
<body>
...
<script src="{{url('js/backend_js/excanvas.min.js')}}"></script>
...
<script src="{{url('js/backend_js/jquery.flot.min.js')}}"></script>
<script src="{{url('js/backend_js/jquery.flot.resize.min.js')}}"></script>
<script src="{{url('js/backend_js/jquery.peity.min.js')}}"></script>
<script src="{{url('js/backend_js/fullcalendar.min.js')}}"></script>
<script src="{{url('js/backend_js/matrix.js')}}"></script>
<script src="{{url('js/backend_js/matrix.dashboard.js')}}"></script>
<script src="{{url('js/backend_js/jquery.gritter.min.js')}}"></script>
<script src="{{url('js/backend_js/matrix.interface.js')}}"></script>
{{--<script src="{{url('js/backend_js/matrix.chat.js')}}"></script>--}}
<script src="{{url('js/backend_js/jquery.validate.js')}}"></script>
<script src="{{url('js/backend_js/matrix.form_validation.js')}}"></script>
<script src="{{url('js/backend_js/jquery.wizard.js')}}"></script>
